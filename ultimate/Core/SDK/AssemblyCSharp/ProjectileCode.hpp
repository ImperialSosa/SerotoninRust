...
public:
	...
	OFFSET:
		...
		DWORD64 st = safe_read(m_game_assembly + 53550704, DWORD64); //Method$Facepunch.Pool.GetList\u003CTraceInfo\u003E() address
		if (!st)
		{
			goto OFFSET;
		}

		Unknown get_list = (Unknown)(m_game_assembly + 18671712);//Method$Facepunch.Pool.GetList\u003CTraceInfo\u003E() MethodAddress
		if (!get_list)
		{
			goto OFFSET;
		}
